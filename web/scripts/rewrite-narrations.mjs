 ...
 * narration を「G先生による単独モノローグ」として書き直す。
...
// ---------------------------------------------------------------------------
// Helper to build a "single-monologue" narration string. G先生 (本講演の
...
// ---------------------------------------------------------------------------
// イントロ N1〜N* は scripts/rewrite-intro.mjs が単独で生成・更新する。
// (Step 10 以降、A薬講演の批判的吟味会話を full set として供給するため、
//  ここでの上書きは行わない。)
// ---------------------------------------------------------------------------
