...
const mapExcerpts: Array<MapExcerpt & { slideIds: string[] }> = [
  ...
  },
  {
    ...
    body: "Core GRADEの作業は、EBMの5ステップを推奨作成に広げたものです。読み手は、どの段階の判断を見ているのかを追うと、情報の使いどころが見えやすくなります。",
  ...
  },
  {
    slideIds: ["S68", "S95"],
    eyebrow: "Step 4",
    title: "EtDは、EBMの判断を透明にする地図",
    body: "利益・害、確実性、価値観、資源、公平性、実行可能性を読めると、エビデンスがどのように患者に関係する判断へ変換されたかが見えます。",
